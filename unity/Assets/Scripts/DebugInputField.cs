	...
	public class DebugInputField : MonoBehaviour
    {
        ...
        public void Execute(string command)
        {
			...
			{            
                ...
                //FloorPlan318 build: 4d43f438653adfea243da2cd9a63fc3d5d9f1ea1
                case "reproarmstuck":
                {
                    List<string> commands = new List<string>();
                    commands.Add("inita");
                    commands.Add("telefull -1.0 0.9017602205276489 0.75 315 10");
                    commands.Add("mmla 1.49011612e-07 0.05 0.4000003 1 True False True");
                    commands.Add("mmla 0.050000208616257 0.0 0.400000423 1 True False True");
                    commands.Add("rc 45 True False True 1");
                    commands.Add("pumlh");
                    commands.Add("mmla 0.05000055 0.0 0.4500008 1 True False True");
                    commands.Add("mmlah 0.3833337017660478 1 True False True False");
                    commands.Add("mmlah 0.4333340911362662 1 True False True False");
                    commands.Add("mmla 9.059999999949664e-07 5.96046448e-08 0.450001121 1 True False True");
                    commands.Add("mmlah 0.38333446272871363 1 True False True False");
                    commands.Add("mmla -0.04999895691872 2.98023224e-08 0.450001448 1 True False True");
                    commands.Add("mc 0.0 0.0 0.2 1");
                    commands.Add("mmlah 0.33333484150634374 1 True False True False");
                    commands.Add("mc 0.0 0.0 0.2 1");
                    commands.Add("mmlah 0.38333521806175214 1 True False True False");
                    commands.Add("mmla -0.04999879 -0.049999947845935803 0.4500018 1 True False True");
                    commands.Add("mmla -0.04999861 -0.09999996 0.450002164 1 True False True");
                    commands.Add("mmla -0.0999984324 -0.09999997 0.450002521 1 True False True");
                    commands.Add("mmla -0.0999982655 -0.14999996999999998 0.450002879 1 True False True");
                    commands.Add("mmlah 0.3333356081727111 1 True False True False");
                    commands.Add("mmla -0.0999982059 -0.04999996999999999 0.450003 1 True False True");
                    commands.Add("mc 0.0 0.0 0.2 1");
                    commands.Add("mmlah 0.3333356081727111 1 True False True False");
                    commands.Add("pumlh");
                    commands.Add("rc -45 True False True 1");
                    commands.Add("mmlah 0.28333599806144777 1 True False True False");
                    commands.Add("rc -45 True False True 1");
                    commands.Add("rc -45 True False True 1");
                    commands.Add("rc 45 True False True 1");
                    commands.Add("mmlah 0.38333599806144775 1 True False True False");
                    commands.Add("mmla -0.09999803 -0.04999999 0.40000335600000003 1 True False True");
                    commands.Add("mmla -0.09999785 1.0000000001675335e-08 0.400003761 1 True False True");
                    commands.Add("mmla -0.09999767 0.0500000223517418 0.400004119 1 True False True");
                    commands.Add("mmla -0.09999749 3.429999999998712e-08 0.400004476 1 True False True");
                    commands.Add("rc 45 True False True 1");
                    commands.Add("mmlah 0.4333363874316661 1 True False True False");
                    commands.Add("rc 45 True False True 1");
                    commands.Add("mmla -0.09999731 5.96046448e-08 0.350004834 1 True False True");
                    commands.Add("mmla -0.09999716 5.96046448e-08 0.400004971 1 True False True");
                    commands.Add("rc -45 True False True 1");
                    commands.Add("mmlah 0.3833367590241135 1 True False True False");
                    commands.Add("mmla -0.0999969542 0.050000029802322404 0.4000053 1 True False True");
                    commands.Add("mmla -0.0499967754 0.0499999821 0.400005668 1 True False True");
                    commands.Add("pumlh");
                    commands.Add("mc 0.0 0.0 0.2 1");
                    commands.Add("mmla -0.1499967158 0.0499999821 0.4000058 1 True False True");
                    commands.Add("mmla -0.149996683 -1.790000000306824e-08 0.400006115 1 True False True");
